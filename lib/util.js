...
function buildParcelRegistry( directory, rootDir, options, dirOptions ) {
	...
	*/
	...
	//	console.log( "assigning name: " + namespacedPageName );
		parcelRegistry[ parcelName ] = CarteroFactory.createParcel( {
			name : parcelName,
			path : parcelPath,
			folder : parcelFolder,
...
exports.buildParcelRegistry = function( dirs, bundleRegistry, options ) {
