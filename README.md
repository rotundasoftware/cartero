...
// NOTE: All paths in this file are relative to the `projectDir`, as specified in your gruntfile
{
	mode : "dev",

	// the path of the `publicDir` (relative to `projectDir`, as are all paths in this file)
	publicDir : "static",
