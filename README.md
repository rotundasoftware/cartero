...
The days of organizing directories by the type of files they contain are over. The new black is organizing applications into packages that contain HTML, JavaScript, css, and images. npm enables you to easily author, reuse, and share such packages. Cartero provides web applications with an easy way to consume them.
